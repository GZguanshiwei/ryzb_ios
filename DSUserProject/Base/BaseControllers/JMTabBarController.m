...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController{
    ...
    UIViewController *topVC = nav.viewControllers.firstObject;
    if([topVC isKindOfClass:[ShopCartViewController class]] || [topVC isKindOfClass:[UserCenterViewController class]]){
        if([[JMProjectManager sharedJMProjectManager] isTourist]){
            rtn = NO;
        }
    }
    return rtn;
