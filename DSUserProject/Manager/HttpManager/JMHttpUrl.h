...
#define kUrlLogisticsWithLogisticsNo    fPinUrl(@"api/order/selectLogistics")//查看物流状态 (新)
...
#define kUrlJianBaoPrice            fPinUrl(@"api/configure/getAppraisalPrice")//鉴宝费用
...
#define kUrlGTClientId              fPinUrl(@"api/account/bindClientId")//个推id
#define kUrlLiveIron                fPinUrl(@"api/room/account/getIronValue")//铁值任务完成
